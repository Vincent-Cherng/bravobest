...
public class Evaluation implements Serializable {
    ...
    private static final long serialVersionUID = 1504742804165635298L;
    ...
    private String evalutionPerson;//考评人
    private String userNo;//被考评人

    private String evalutionId;//考评id
    private String evalutionType;//考评类型（管理者或者员工）
    private String evalutionPeriod;//考评周期
    private String totalEvaluationPoint;//考评总分
    ...
    public String getEvalutionPerson() {
        return evalutionPerson;
    }

    public void setEvalutionPerson(String evalutionPerson) {
        this.evalutionPerson = evalutionPerson;
    }
    ...
    public String getTotalEvaluationPoint() {
        return totalEvaluationPoint;
    }

    public void setTotalEvaluationPoint(String totalEvaluationPoint) {
